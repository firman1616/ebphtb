        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              $status = $row->status; 
              if ($status == '0') { ?>
                <a class="btn btn-app" href="<?php echo base_url('dinas/BPHTB/editBphtb/'.$row->nop) ?>">
                  <i class="fa fa-edit"></i> Edit
                </a>
                <a class="btn btn-app" href="<?php echo base_url('dinas/BPHTB/hapusData/'.$row->nop) ?>" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')">
                  <i class="fa fa-trash"></i> Hapus
                </a>
              <?php } else { ?>
                <a href="<?php echo base_url('dinas/BPHTB/cetak/'.$row->nop) ?>" class="btn btn-app">
  ...
  <div class="modal fade" id="myModalView<?php echo $y++; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        ...
        <?php 
          ...
          if ($status_op == '0') { ?>
            <a href="<?php echo base_url('dinas/BPHTB/approve/'.$row->nop) ?>"><button type="button" class="btn btn-primary" onclick="return confirm('Apakah Data Sudah Benar ?')">Setujui</button></a>
            <?php 
          } else { 
            ?>
            &nbsp
