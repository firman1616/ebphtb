                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          	...
                          	<a href="<?php echo base_url('dinas/Notaris/hapus_data_notaris/'.$row->id_notaris) ?>" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')"><button type="button" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
