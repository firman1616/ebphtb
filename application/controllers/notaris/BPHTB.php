...
class BPHTB extends CI_Controller {
	...
	public function index()
	{
		...
		$data['conten'] 	= 'conten_notaris/input_sspd';
		$data['title'] 		= 'Form SSPD Notaris';
		...
		$data['tanah'] = $this->M_data->get_data('jenis_surat_tanah');
	...
	public function simpanData(){
		...
		$data[] = array(
			...
			'ket' 						=> $args['keterangan'],
			'notaris_pengusul'			=> $args['pengusul']
		);
	...
	public function listBphtb(){
		...
		$data['data_notaris'] 	= $this->M_data->foto_notaris_by_id($data['id']);
		$data['foto'] 			= $this->M_data->foto_notaris($data['name']);
		$data['conten'] 	 	= 'conten_notaris/list_bphtb';
		$data['title']  	 	= 'Daftar BPHTB';
		$data['detail_bphtb']	= $this->M_data->join_wp_notaris($data['name']);
		$this->load->view('template/notaris/conten',$data);
	}
	...
	public function editBphtb($id)/*$id*/
	{
		...
		$data['id'] 			= $this->session->userdata('id');
		$data['data_notaris'] 	= $this->M_data->foto_notaris_by_id($data['id']);
		$data['conten']      = 'conten_notaris/edit_bphtb';
	...
	public function editData($id){
		...
		/*return redirect($_SERVER['HTTP_REFERER']);*/
		redirect('notaris/BPHTB/listBphtb');
	}
	...
	public function cetak($id) /*iki control cetak*/
	{
		...
		$data['data_notaris'] 	= $this->M_data->foto_notaris_by_id($data['id']);
		$data['foto'] 	= $this->M_data->foto_notaris($data['name']);
		$data['conten'] = 'conten_notaris/cetak_form';
		$data['title'] 	= 'Cetak Form SSPD BPHTB';
		$data['cetak'] 	= $this->M_data->cetak_sspd($id);
		/*$data['id_wp'] = $this->M_data->wajib_pajak();*/
		$this->load->view('conten_notaris/cetak_form',$data);
	}
