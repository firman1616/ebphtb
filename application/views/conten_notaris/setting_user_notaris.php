                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                      	...
                      	$x=1;
                        $no=1;
                      	foreach ($user_notaris->result() as $row) { ?>
                        <tr>
                          <td><?php echo $x++; ?></td>
  ...
  <div class="modal-dialog modal-bg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?php echo base_url('Setting/update_user_notaris/'.$row->id_user_notaris) ?>">
          <div class="form-group">
                <input class="form-control" readonly name='nama' value="<?php echo $row->nama_notaris; ?>" required>
          </div>
          <div class="form-group">
