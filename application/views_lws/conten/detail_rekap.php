                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    ...
                                    ?></td>
                                <td><a href="<?php echo base_url('Rekapitulasi/detail_rekap_pertanggal?param='.$year.'-'.$i.'&notaris='.$notaris.'&bulan='.$bulan) ?>"> <button type="button" class="btn btn-primary"><i class="fa fa-list"></i> Detail</button> </a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
