...
<div class="right_col" role="main">
  <div class="">
    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url('BPHTB/simpanData'); ?>" name="input_bphtb">
                ...
                <div id="step-1">
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="perolehan" id="perolehan" style="width: 100%;" class="select2 form-control" data-live-search="true" title="Pilih Salah Satu" required id="perolehan">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input list="data_nop" type="number" id="nop" name="nop" required="required" class="form-control col-md-7 col-xs-12" onchange="return autofill();" onfocus="startGetNop()" onblur="stopGetNop()">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="kd_booking" id="kd_booking" readonly="yes" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <input type="text" name="njop_total" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <input type="text" name="harga_transaksi" id="harga_transaksi" required="required" readonly="yes" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="npop" id="npop" required="required" readonly="yes" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
...
<script>
    function autofill(){
        ...
        $.ajax({
                 url:"<?php echo base_url();?>BPHTB/cari",
                 data:'&nop='+nop,
    ...
    function getHarga(){
      ...
      var harga         = ((njop_tanah * l_tanah) + (njop_bangunan * l_bangunan));
      document.getElementById('harga_transaksi').value = harga;
      document.getElementById('npop').value = harga;
    }

    function stopGetHarga() {
      celarInterval(interval2);
    }
