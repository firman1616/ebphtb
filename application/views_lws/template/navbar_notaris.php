        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url('Dashboard'); ?>" class="site_title"><i class="fa fa-file-text-o"></i> <span> &nbsp;E-BPHTB</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo base_url('Rekapitulasi') ?>"><i class="fa fa-link"></i> Rekapitulasi SSPD </a>
                  </li>
                  <li><a><i class="fa fa-file-text-o"></i> SSPD BPHTB <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">                      
                      <li><a href="<?php echo base_url('BPHTB') ?>">Input Data SSPD</a></li>
                      <li><a href="<?php echo base_url('BPHTB/listBphtb') ?>">Daftar Data SSPD</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-book"></i> Notaris <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('Notaris') ?>">Tambah Data</a></li>
                      <li><a href="<?php echo base_url('Notaris/data_notaris') ?>">Data Notaris</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-gear"></i> Setting <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('Setting') ?>">Setting User</a></li>
                      <li><a href="<?php echo base_url('Setting/user_notaris') ?>">Setting User Notaris</a></li>
                    </ul>
                  </li>
                  </li>
                </ul>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url('assets/img/icon_foto.jpg'); ?>" alt="">John Doe
