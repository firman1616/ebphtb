              ...
              <div id="wizard" class="form_wizard wizard_horizontal">
                ...
                <div id="step-1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="jenis_surat_tanah" id="perolehan" style="width: 100%;" class="select2 form-control" data-live-search="true" title="Pilih Salah Satu" required id="perolehan">
                          <option value="">-- Pilih Salah Satu --</option>
                        <?php 
...
<script>
    function autofill(){
        ...
        $.ajax({
                 url:"<?php echo base_url();?>dinas/BPHTB/cari",
                 data:'&nop='+nop,
    ...
    function getHarga(){
      ...
      var harga_trans   = parseInt(document.getElementById('harga_transaksi')).value;
      var total_njop    = parseInt(((njop_tanah * l_tanah) + (njop_bangunan * l_bangunan)));
