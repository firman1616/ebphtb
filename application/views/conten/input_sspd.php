...
<div class="right_col" role="main">
  <div class="">
    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url('dinas/BPHTB/simpanData'); ?>" name="input_bphtb">
                ...
                <div id="step-1">
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="perolehan" id="perolehan" style="width: 100%;" class="form-control" title="Pilih Salah Satu" required id="perolehan">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input list="data_nop" type="text" id="nop" name="nop" required="required" class="form-control col-md-7 col-xs-12" onchange="return autofill();" onfocus="startGetNop()" onblur="stopGetNop()">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="jenis_surat_tanah" id="perolehan" style="width: 100%;" class="form-control" title="Pilih Salah Satu" required id="perolehan">
                          <option value="">-- Pilih Salah Satu --</option>
                        <?php 
