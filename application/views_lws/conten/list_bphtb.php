        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              $status = $row->status; 
              if ($status == '0') { ?>
                <a class="btn btn-app" href="<?php echo base_url('BPHTB/editBphtb/'.$row->nop) ?>">
                  <i class="fa fa-edit"></i> Edit
                </a>
                <a class="btn btn-app" href="<?php echo base_url('BPHTB/hapusData/'.$row->nop) ?>" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')">
                  <i class="fa fa-trash"></i> Hapus
                </a>
              <?php } else { ?>
                <a href="<?php echo base_url('BPHTB/cetak/'.$row->nop) ?>" class="btn btn-app">
