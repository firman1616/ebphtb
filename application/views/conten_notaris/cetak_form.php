...
<table width="840" style="border-bottom:solid black; border-left:solid black; border-right:solid black;">
  <tr>
    ...
    <td colspan="3"><?php echo $nama_penjual; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>2. NPWP (Badan) </td>
    <td><center>:</center></td>
    <td colspan="3"><?php echo $npwp_penjual; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>3. NIK (Perorangan) </td>
    <td><center>:</center></td>
    <td colspan="3"><?php echo $no_identitas_penjual; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>4. Alamat Wajib Pajak </td>
    <td><center>:</center></td>
    <td colspan="3"><?php echo $alamat_penjual; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>5. Kelurahan / Desa </td>
    <td><center>:</center></td>
    <td width="111"><?php echo $desa_penjual; ?></td>
    <td width="198">6. RT / RW   : <?php echo $rt_penjual." / ".$rw_penjual; ?></td>
    <td width="205">7. Kecamatan : <?php echo $kecamatan_penjual; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>8. Kabupaten / Kota </td>
    <td><center>:</center></td>
    <td><?php echo $kabupaten_penjual; ?></td>
    <td colspan="2">9. Kode Pos : <?php echo $kd_pos_penjual; ?></td>
  </tr>
</table>
<table width="840" style="border-bottom:solid black; border-left:solid black; border-right:solid black;">
  <tr>
