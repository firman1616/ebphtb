...
<div class="row" align="center">
  ...
  <div class="container">
    ...
    <form class="form-signin2" style="color: snow">
      ...
      <p style="color: black; font-size: 20px; margin-top: 4px">Jl. Aloon-Aloon Utara No.4, Ponorogo, Mangkujayan, Kec. Ponorogo,<br> Kabupaten Ponorogo, Jawa Timur 63413</p>
    </form>
  </div>
